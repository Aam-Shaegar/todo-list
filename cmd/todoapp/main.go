...
import (
	...
	core_config "github.com/Aam-Shaegar/todo-list/internal/core/config"
	...
	users_service "github.com/Aam-Shaegar/todo-list/internal/features/users/service"
	users_transport_http "github.com/Aam-Shaegar/todo-list/internal/features/users/transport/http"
	"go.uber.org/zap"
)
...
func main() {
	...
	if err != nil {
		fmt.Println("failed to init appllication logger:", err)
		os.Exit(1)
	}
	...
	logger.Debug("initializid feature", zap.String("feature", "users"))
	usersRepository := users_postgres_repositpory.NewUsersRepository(pool)
